...
#var_dump($product);
    ...
    foreach ($opinions as $opinion) {
        $op = mysqli_query($mysqli, "Insert Into etl.opinions (serial_number, product_id, text, stars, author, date, recomended, useful, useless) VALUES ('$productId', '$id','" . $opinion['Opis'] . "','" . $opinion['Gwiazdki'] . "','" . $opinion['Opiniujacy'] . "','" . $opinion['Data opinii'] . "','" . $opinion['Rekomendacja'] . "','" . $opinion['Na TAK'] . "','" . $opinion['Na NIE'] . "')");
